...
var currentPage;
var lastStats;
var numberFormatter = new Intl.NumberFormat('en-US',{ maximumSignificantDigits: 10 }); // US formatting, force commas.
...
function getReadableCoins(coins, digits, withoutSymbol){
    var amount = (parseInt(coins || 0) / coinUnits).toFixed(digits || coinUnits.toString().length);
